...
export const SearchInput = ({ defaultValue }: iDefault) => {
  ...
  return (
    <div className="w-full sm:w-[500px] lg:w-[700px] search__input relative border-b border-solid border-slate-400 flex flex-row items-center gap-5 my-10 lg:my-16 ">
      <input
        type="text"
        id="inputId"
      ...
      />
      <div className="pr-2"><RiSoundModuleLine size={20} color="#64748b"/></div>
